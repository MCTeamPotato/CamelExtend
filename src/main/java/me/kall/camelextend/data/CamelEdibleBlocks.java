...
import me.kall.camelextend.CamelExtend;
...
public class CamelEdibleBlocks extends ChunkData.BlockData {
    ...
    public @Nullable Predicate<BlockState> validation() {
        return state -> state.is(CamelExtend.CAMEL_EDIBLE);
    }

    public static @NotNull ChunkData<Long, BlockState> get(ServerLevel level) {
        return get(level, CamelEdibleBlocks::new, "CamelExtendEdibleBlockStorage");
    }
}
